"""
Django settings for Invetario_ICED project.
...
SECRET_KEY = 'django-insecure-1^&8*kpfr+!fzmgzzk=m(+!d#o@)q6s7r+x6a=o=sr*5-$q)in'
...
WSGI_APPLICATION = 'Invetario_ICED.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'DB_ICED',#ponemos datos para la conexion de la base de datos
    }
}
